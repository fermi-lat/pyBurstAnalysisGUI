...
IRFS['P8_TRANSIENT010E']    = IRF('P8_TRANSIENT010E'  , 'P8R3_TRANSIENT010E_V2' , '305',    32, galactic, 'iso_P8R3_TRANSIENT010E_V2.txt')
IRFS['P8_TRANSIENT010']     = IRF('P8_TRANSIENT010' ,   'P8R3_TRANSIENT010_V2'  , '305',    64, galactic, 'iso_P8R3_TRANSIENT010E_V2.txt')
IRFS['P8_SOURCE']           = IRF('P8_SOURCE'        ,  'P8R3_SOURCE_V2'       ,  '305',   128, galactic, 'iso_P8R3_SOURCE_V2.txt')
IRFS['P8_CLEAN']            = IRF('P8_CLEAN'         ,  'P8R3_CLEAN_V2'       ,   '305',   256, galactic, 'iso_P8R3_CLEAN_V2.txt')
IRFS['P8_ULTRACLEAN']       = IRF('P8_ULTRACLEAN' ,     'P8R3_ULTRACLEAN_V2'    , '305',   512, galactic, 'iso_P8R3_ULTRACLEAN_V2.txt')
IRFS['P8_ULTRACLEANVETO']   = IRF('P8_ULTRACLEANVETO',  'P8R3_ULTRACLEANVETO_V2', '305',  1024, galactic, 'iso_P8R3_ULTRACLEANVETO_V2.txt')
IRFS['P8_SOURCEVETO']       = IRF('P8_SOURCEVETO',      'P8R3_SOURCEVETO_V2',     '305',  2048, galactic, 'iso_P8R3_SOURCEVETO_V2.txt')
IRFS['P8_TRANSIENT100S']    = IRF('P8_TRANSIENT100S' ,  'P8R3_TRANSIENT100S_V2' , '305', 32768, galactic, 'iso_P8R3_TRANSIENT0100S_V2.txt') # YOU SHOULD USE THE BKGE FOR THIS 
IRFS['P8_TRANSIENT015S']    = IRF('P8_TRANSIENT015S' ,  'P8R3_TRANSIENT015S_V2' , '305', 65536, galactic, 'iso_P8R3_TRANSIENT015S_V2.txt')
